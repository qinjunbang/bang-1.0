module.exports = function(grunt){
    ...
    grunt.initConfig({
        ...
        jshint: {
            ...
            main: {
                src: 'js/bootstrap-3.3.7-datepicker.js'
            },
            locales: {
                src: 'js/locales/*.js'
            },
        ...
        csslint: {
            ...
            dist: [
                'dist/css/bootstrap-3.3.7-datepicker.css',
                'dist/css/bootstrap-3.3.7-datepicker3.css',
                'dist/css/bootstrap-3.3.7-datepicker.standalone.css',
                'dist/css/bootstrap-3.3.7-datepicker3.standalone.css'
            ]
        },
        compress: {
            main: {
        ...
        'string-replace': {
            js: {
                files: [{
                    src: 'js/bootstrap-3.3.7-datepicker.js',
                    dest: 'js/bootstrap-3.3.7-datepicker.js'
                }],
                options: {
                    replacements: [{
